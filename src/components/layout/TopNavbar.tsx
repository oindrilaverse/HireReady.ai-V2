...
export function TopNavbar() {
  ...
  return (
    <header className="h-16 border-b border-white/5 bg-[#09090b]/45 backdrop-blur-md sticky top-0 z-30 flex items-center justify-between px-6">
      <div className="flex items-center flex-1">
        <div className="relative w-full max-w-md hidden md:block">
          ...
          <input 
            ...
            className="w-full bg-white/5 border border-white/10 rounded-full py-1.5 pl-10 pr-4 text-sm text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-[#007bff]/30 focus:border-transparent transition-all"
          />
        </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-[#007bff] to-[#8b5cf6] flex items-center justify-center text-white text-xs font-bold border-2 border-white/10 shadow-lg">
                  {initials}
                </div>
